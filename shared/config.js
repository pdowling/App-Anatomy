var config = {
  tabData: {
    tab1: [
      'Git change...more...and more again....martin!!This app demonstrates how to use client-side packages to configure element positioning and present different UI themes.',
